...
PYMODS = 
BINFILES =
USRBINFILES = dsctl-virt-notify-user
EXTENSIONS = 
MENUFILES = 
MIMEFILES = 
EXTRATARGETS = 
...
install:	install-bin install-extension install-icon install-lang install-lib install-ui install-usrbin install-usrsbin
